...
<div class="container my-5">
    ...
    <div class="col-lg-8 px-0">
        <p class="fs-5">Üdv itt, nézz körül!</p>
        <hr class="col-1 my-4">

        <a href="termekek.php" class="btn btn-primary">Termékek</a>
        <a href="vevok.php" class="btn btn-danger">Vevők</a>
        <a href="megrendelesek.php" class="btn btn-warning">Megrendelés</a>
    </div>
</div>
